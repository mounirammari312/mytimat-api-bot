...
# إضافة مجلد api الحالي لمسارات Python لمنع أخطاء الاستدعاء في Vercel
...
def get_direct_stream():
  """نقطة جلب البث المزدوجة والمحسنة (أكوام 👈 ثم لاروزا Fallback)."""
  ...
  # 2. المحاولة الثانية: كشط موقع لاروزا
